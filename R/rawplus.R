...
#' @title rawplus_consent
#' @format a data frame with 1297 rows and 4 columns.
#' @description Visits (visdt) data in ` rawplus ` format.
#' \describe{
#'   \item{subjid}{` string ` Subject Identifier}
#'   \item{consdt}{` date ` Date of Consent}
#'   \item{conscat}{` string ` Individual giving consent}
#'   \item{consyn}{` character ` Consent Indication}
#' }
#' @source ./data-raw/rawplus/rawplus_consent.rda
"rawplus_consent"

#' @title rawplus_enroll
#' @format a data frame with 2387 rows and 9 columns.
#' @description Visits (visdt) data in ` rawplus ` format.
#' \describe{
#'   \item{studyid}{` string ` Study Identifier}
#'   \item{siteid}{` string ` Site Identifier}
#'   \item{subjectid}{` string ` Detailed subject Identifier}
#'   \item{subjid}{` string ` Trial Subject Identifier}
#'   \item{enroll_dt}{` date ` Date of enrollment in clinical trial}
#'   \item{enrollyn}{` character ` Indicator of enrollment in clinical trial, Y = yes, N = no}
#'   \item{sfreas}{` string ` Reason for withrawl from trial}
#'   \item{country}{` string ` Country of trial}
#'   \item{invid}{` string ` Subject Identifier}
#' }
#' @source ./data/rawplus_enroll.rda
"rawplus_enroll"


#' @title rawplus_ie
#' @format a data frame with 30168 rows and 4 columns.
#' @description Visits (visdt) data in ` rawplus ` format.
#' \describe{
#'   \item{subjid}{` string ` Study subject identifier}
#'   \item{iecat}{` string ` Indicator for inclusion (INCL) or exclusion (EXCL)}
#'   \item{ieorres}{` character ` Indicator for inclusion (1) or exclusion (0)}
#'   \item{tiver}{` string ` Trial version indicator}
#' }
#' @source ./data-raw/rawplus/rawplus_ie.rda
"rawplus_ie"
