...
test_that("direct specified input gives correct output", {
  ...
  dfTos2 <- structure(list(
    SubjectID = c(1, 2, 2, 3, 4, 5), SiteID = c(1, 1, 2, 2, 2, 2), FirstDoseDate = structure(c(
      16340, 16340, 16340,
      16340, 16340, 16340
    ), class = "Date"), LastDoseDate = structure(c(17071, 17071, 17071, 17071, 17071, 17071), class = "Date"),
    TimeOnTreatment = c(732, 732, 732, 732, 732, 732)
